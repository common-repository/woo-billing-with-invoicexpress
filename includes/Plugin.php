...
class Plugin {
	 ...
	 * @since 5.9
	 */
	public function set_document_type_names() {
		// On init (after after_setup_theme) since WordPress 6.7 to avoid load_plugin_textdomain notices
		add_action(
			'init',
			function () {
	...
	public function define_hooks() {
		...
		add_action( 'init', array( $this, 'get_create_documents_options' ) );
