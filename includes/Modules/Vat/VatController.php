...
class VatController {
	...
	public function register_hooks() {
		...
		add_action( 'after_setup_theme', function() {
			...
			if ( get_option( 'hd_wc_ie_plus_vat_field' ) ) {
				...
				// Thank you / Order details in My Account - Add VAT number
				add_action(
					apply_filters( 'invoicexpress_woocommerce_vat_position_my_account', 'woocommerce_order_details_after_customer_details' ),
					array( $this, 'woocommerce_order_details_after_customer_details' ),
					apply_filters( 'invoicexpress_woocommerce_vat_position_my_account_priority', 10 )
				);
	...
	/**
	 * Add field to customer details on the Thank You page and Order details on My Account
	 *
